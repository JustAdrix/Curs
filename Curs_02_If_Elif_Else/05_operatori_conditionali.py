...
if number > 12:
    print(f"da, {number} este mai mare")   #  spatiu de identare (inainte de print) - apartine doar de blocul "if"
else:      #    daca nu fac astalalta
    print(f"nu, nu este mai mare ")  # spatiu identat care apartine doar bloacului de "else"
    print("exact")
