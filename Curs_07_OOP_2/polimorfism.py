...
class BioProduct(Product):
    def __init__(self, price, name, surce):
...
def see_product_label(products):
...
see_product_label(ps)

# Polimorfismul este conceptul de a furniza o singura interfata catre diferite tipuri de obiecte.
# In exemplul de mai sus apare ideea de subtipare prin caer in momentul in care codul este rulat isi va da sema din
# ce clasa este apelata functia label pentru a afisa numele clasei corespunzator